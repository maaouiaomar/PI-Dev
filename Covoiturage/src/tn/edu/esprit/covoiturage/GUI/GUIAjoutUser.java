 ...
 * @author AMINE
 */
public class GUIAjoutUser extends javax.swing.JFrame {

    private static GUIAjoutUser instance;
    Utilisateur ul;
JTable t;
    /**
     * Creates new form AjoutPhar
     */
    private GUIAjoutUser() {
    ...
    public static GUIAjoutUser GetInstance() {
        if (instance == null) {
            instance = new GUIAjoutUser();
        }
        return instance;
    }
    ...
    private void btnInscriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInscriActionPerformed
        ...
        if (!rempliComplet()) {
        ...
        else if(!CtrlAjoutUser.IsUsed(txtLogin.getText().toString())){
         ...
         try {
                ...
                JOptionPane.showMessageDialog(rootPane, "ERREUR lors de l'ajout");
            }
